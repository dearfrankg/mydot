...
AWS_PUBLIC_IP=54.186.114.160
aws2root=" -i /Users/frankg/.ssh/mbp.pem ubuntu@$AWS_PUBLIC_IP "
aws2="ubuntu@$AWS_PUBLIC_IP"
alias dokku="ssh -t dokku@$AWS_PUBLIC_IP "
